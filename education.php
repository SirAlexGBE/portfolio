...
<meta name="author" content="Alex Kandel" />
  ...
  <body>
    <div class="container">
      ...
      <section class=" main-content education-experience">
  <h2 class="section-title">Education & <span class="highlight">Experience</span></h2>
  ...
  <div class="timeline">
    ...
    <div class="timeline-item">
      <span class="year">2023 - Present</span>
      <h3 class="position">BSc (Hons) Computer Systems Engineering (IT)</h3>
      ...
      <div class="sidebar navbar navbar-expand-lg navbar-light">
        ...
        <a href="education.php" class="active"><i data-lucide="school"></i></a>
